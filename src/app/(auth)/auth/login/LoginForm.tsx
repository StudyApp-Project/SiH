    ...
    <form onSubmit={handleLogin} className="space-y-4">
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="bg-white px-2 text-slate-500">{t('demoPersona')}</span>
        </div>
      </div>
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-4 py-2.5 text-sm font-semibold text-slate-700 shadow-sm transition hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
      >
      ...
      <p className="text-center text-sm text-slate-600">
        {t('noAccount')}{' '}
        <a href="/auth/signup" className="font-medium text-blue-700 hover:text-blue-800">
          {t('signup')}
        </a>
      </p>
    </form>
