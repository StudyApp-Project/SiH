      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12">
        <div className="w-full max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-2.5 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800 text-xs font-semibold text-blue-800 dark:text-blue-300">
            ...
            <div className="lg:col-span-7 bg-white dark:bg-zinc-900 rounded-2xl border border-slate-200 dark:border-zinc-800 p-6 sm:p-7 shadow-sm space-y-4">
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs font-semibold px-2.5 py-1 rounded-full bg-amber-50 dark:bg-amber-950/60 text-amber-700 dark:text-amber-400 border border-amber-200 dark:border-amber-800">
                    1-Click Simulation
                  </span>
                </div>
                <p className="text-xs text-slate-500 dark:text-zinc-400 mt-1">
...
function DemoPersonaCard({
  ...
  const iconStyles = {
    ...
    emerald: 'bg-emerald-100 text-emerald-700 dark:bg-emerald-950/80 dark:text-emerald-300',
    purple: 'bg-purple-100 text-purple-700 dark:bg-purple-950/80 dark:text-purple-300',
    amber: 'bg-amber-100 text-amber-700 dark:bg-amber-950/80 dark:text-amber-300',
  };

  return (
    <a
      href={`/api/sso/demo-persona?email=${encodeURIComponent(email)}&lang=${lang}`}
      className="group flex flex-col justify-between p-4 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-800/40 hover:bg-blue-50/60 dark:hover:bg-zinc-800 hover:border-blue-300 dark:hover:border-blue-700 transition-all text-left"
    >
