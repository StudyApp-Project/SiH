    ...
    <div className="mt-8">
      ...
      <div className="min-h-75">
              ...
              {cadres.map((c) => (
                <button
                  ...
                  className={`p-6 rounded-xl border text-left transition-all ${
                    formData.cadre === c.id
                      ? 'border-blue-600 bg-blue-50 dark:border-blue-500 dark:bg-blue-950/40 shadow-sm'
        ...
        {step === 2 && (
          <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2">
            ...
            {formData.cadre === 'FOD' && (
              <div className="mt-6 p-4 rounded-lg bg-amber-50 text-amber-800 dark:bg-amber-950/60 dark:text-amber-300 border border-amber-200 dark:border-amber-900 text-sm flex items-start gap-3">
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 max-w-md mx-auto py-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-800 px-3.5 py-2.5 text-sm text-slate-900 dark:text-zinc-100 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
            ...
            <button
              onClick={handleNext}
              className="w-full rounded-lg bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 px-4 py-2.5 text-sm font-semibold text-white transition-colors shadow-sm mt-4"
            >
              {t('common.next')}
            </button>
          </div>
        ...
        {step === 4 && (
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2">
            ...
            <div className="bg-slate-50 dark:bg-zinc-900/60 p-6 rounded-xl border border-slate-200 dark:border-zinc-800 text-center space-y-4 my-8">
            ...
            <button
              ...
              disabled={loading}
              className="w-full rounded-lg bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 px-4 py-3 text-sm font-semibold text-white transition-colors shadow-sm flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
      ...
      <div className="mt-8 flex items-center h-10">
        {step > 1 && (
          <button
            onClick={handleBack}
            className="text-sm font-medium text-slate-600 hover:text-slate-900 dark:text-zinc-400 dark:hover:text-zinc-100 flex items-center gap-2 transition-colors"
          >
            ← {t('onboarding.back')}
          </button>
        )}
