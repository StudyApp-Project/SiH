...
import { X, FileBox, BrainCircuit, CheckCircle2, Target } from 'lucide-react';
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-between p-6 border-b border-(--border-subtle) bg-(--bg-glass) backdrop-blur-md">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[color:oklch(0.58_0.22_var(--accent-hue)_/_0.1)] flex items-center justify-center">
                  <Target className="w-5 h-5 text-[color:oklch(0.58_0.22_var(--accent-hue))]" />
                </div>
                <h2 className="text-xl font-bold" style={{ fontFamily: 'var(--font-display)' }}>Create Quiz</h2>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-6 overflow-y-auto flex-1">
              ...
              <p className="text-sm text-(--text-secondary) mb-4">Choose PDFs to generate quiz questions from.</p>
              ...
              <h3 className="font-semibold text-(--text-primary) mb-3 text-sm uppercase tracking-wider">Number of Questions</h3>
              <div className="flex items-center gap-4 bg-(--bg-glass) backdrop-blur-md p-4 rounded-xl border border-(--border-subtle)">
                <span className="text-xs text-(--text-muted) font-bold">5</span>
                <input
                  type="range"
                  min="5"
                  max="20"
